...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["upload"]) && $_FILES["upload"]["error"] == 0) {
        ...
        if (move_uploaded_file($_FILES["upload"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO BookCover (resource_file, other_details) VALUES (?, ?)";
...
<head>
  ...
  <link href="../CC_Video_Advertisining/css/bookCover.css" rel="stylesheet">
</head>
<body>
  <!-- Navbar -->
  ...
  <main class="container py-4">
    ...
    <form action="bookCover.php" method="POST" enctype="multipart/form-data">
      <div class="mb-3">

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert into SocialMediaPost Table
    $sql = "INSERT INTO SocialMediaPost (resource_file, other_details) VALUES (?, ?)";
...
<head>
  ...
  <link href="../CC_Video_Advertisining/css/socialMediaPost.css" rel="stylesheet">
</head>
<body>
  <!-- Navbar -->
  ...
  <main class="container py-4">
    ...
    <p class="text-muted">Social Media Post</p>

    <form action="socialMediaPost.php" method="POST" enctype="multipart/form-data">
      <div class="mb-3">

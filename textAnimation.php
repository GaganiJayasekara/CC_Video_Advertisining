...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $voice_preference = $_POST['voice'] ?? '';
    $script_text = $_POST['script'] ?? '';
    ...
    $sql = "INSERT INTO TextAnimationVideoAd (time_duration, voice_preference, script_text, resource_file, other_details) VALUES (?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("sssss", $time_duration, $voice_preference, $script_text, $resource_file, $other_details);
...
<body>
  ...
  <div class="dropdown-content position-absolute bg-white border rounded shadow" id="signoutMenu" style="display: none; right: 0;">
    <a href="../CC_Video_Advertisining/start.html" class="d-block px-3 py-2 text-dark text-decoration-none">Sign Out</a>
        ...
        <main>
          <form action="textAnimation.php" method="POST" enctype="multipart/form-data">
  <div class="form-group">
    <label for="duration">Enter your time duration</label>
    <input type="text" id="duration" name="duration">
  </div>
  <div class="form-group">
    <label for="voice">What do you want voice</label>
